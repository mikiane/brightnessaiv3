...
rss_urls = [
    ["Gen AI Brightness", "https://flint.media/bots/feeds/eyJhbGciOiJIUzI1NiJ9.eyJib3RfaWQiOjEyNzYyLCJlZGl0aW9uIjoiY3VycmVudCJ9.K2pXIxZ9BLIxcrXAjoV76D0dLN-lUFJhh7cv2l2CDMw"]
]
...
for site_name, url, link_title in rss_urls:
    prompt = "Exraire les points clés de cet article sur le thème de l'Intelligence Artificielle générative et les reformuler sous la forme d'un résumé en français vulgarisé pour du grand public sans dénaturer la complexité du sujet traité."
    site = url
    input_data = ""
