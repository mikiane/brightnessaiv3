...
## INITIALISATION
print("\033c", end="")
print("Bienvenue dans le generateur de podcasts Brightness AI !\n\n")
print("Ce script va vous permettre de générer un podcast à partir de sources de veille.\n\n")
print("Il va d'abord vous demander de saisir un sujet de veille, puis il va récupérer les sources de veille sur Feedly, les parsant, les résument et les envoyant par mail sous la forme d'une chronique.\n\n")
print("Pour commencer, veuillez saisir un sujet de veille.\n\n")
# confirmation
...
try:
    ...
    print("Erreur : Aucun argument n'a été passé en ligne de commande")
    sys.exit(1)
#############################################################################################################    
"""
