...
rss_urls = [
    ["AI Brightness", "https://flint.media/bots/feeds/eyJhbGciOiJIUzI1NiJ9.eyJib3RfaWQiOjEyNzYxLCJlZGl0aW9uIjoiY3VycmVudCJ9.r5ny-23JS3tyVh5GXBijCj22i40ulrVE6EmJFq9dznw"]
]
...
for site_name, url, link_title in rss_urls:
    prompt = "Exraire les points clés de cet article sur le thème de l'Intelligence Artificielle et les reformuler sous la forme d'un résumé en français vulgarisé pour du grand public sans dénaturer la complexité du sujet traité."
    site = url
    input_data = ""
